...
class CursoCRUD:
    ...
    def atualizar(self, filtro: dict, novos_dados: dict):
        ...
        if "idCurso" in novos_dados:
            print("⚠️ Aviso: O idCurso (Chave Primária) não pode ser alterado. Ignorando este campo.")
    ...
    def deletar(self, filtro: dict):
        ...
        if not curso:
            print("⚠️ Nenhum curso encontrado para remover.")
            return 0
        ...
        try:
            ...
            if resultado.deleted_count > 0:
                print("🗑️ Curso removido com sucesso!")
