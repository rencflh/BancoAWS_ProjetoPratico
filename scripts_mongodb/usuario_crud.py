...
class UsuarioCRUD:
    ...
    def criar_varios(self, lista_de_usuarios: list):
        ...
        for usu in lista_de_usuarios:
            ...
            if self.colecao.find_one({"cpf": cpf}) or (login and self.colecao.find_one({"login": login})):
                print(f"⚠️ Usuário CPF {cpf} / Login '{login}' ignorado: CPF ou Login já cadastrados.")
            else:
    ...
    def atualizar(self, filtro: dict, novos_dados: dict):
        ...
        if "cpf" in novos_dados:
            print("⚠️ Aviso: O CPF (Chave Primária) não pode ser alterado diretamente. Ignorando este campo.")
            del novos_dados["cpf"]
        ...
        try:
            ...
            if resultado.modified_count > 0:
                ...
                print("⚠️ Nenhum dado foi modificado (os dados já eram idênticos).")
    ...
    def deletar(self, filtro: dict):
        ...
        if not usuario:
            print("⚠️ Nenhum usuário encontrado para remover.")
            return 0
        ...
        try:
            ...
            if resultado.deleted_count > 0:
                print("🗑️ Usuário removido do sistema com sucesso!")
